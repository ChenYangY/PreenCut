...
from modules.faster_whisper_speech_recognizer import FasterWhisperSpeechRecognizer
from modules.whisperx_speech_recognizer import WhsiperXSpeechRecognizer
